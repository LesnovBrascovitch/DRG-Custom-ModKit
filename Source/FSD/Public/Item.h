...
public:
    ...
    UFirstPersonStaticMeshComponent* GetFPAnimationEventMesh();
...
protected:
    ...
    virtual void RecieveUnequipped_Implementation();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void RecieveStopUsing();
    virtual void RecieveStopUsing_Implementation();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void RecieveStartUsing();
    virtual void RecieveStartUsing_Implementation();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void RecieveEquipped();
    virtual void RecieveEquipped_Implementation();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void RecieveCycledItem();
    virtual void RecieveCycledItem_Implementation();
...
public:
    ...
    virtual UItemCharacterAnimationSet* GetCharacterAnimationSet_Implementation();
